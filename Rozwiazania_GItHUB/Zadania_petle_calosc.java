...
public class Zadania_petle_calosc {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //kazda z cyfr binarnych wrzucam do tablicy.tutaj obliczam ilosc miejsc w tablicy.
        ...
        int[] binaryArray = new int[integer_power];
                ...
                /*
                 ...
                 String liczba_array="";
                 liczba_array+=numberToBeConverted;
                 int arrayLgth=liczba_array.length();
                */

        binaryCalc(numberToBeConverted, integer_power, binaryArray);
    ...
    static void binaryCalc(int number, int calkowita_power, int binaryArray[]) {

        int additional_parameter;

        while (number > 0) {
            additional_parameter = number % 2;
            number /= 2;
            binaryArray[calkowita_power - 1] = additional_parameter;
            calkowita_power--;
        }
    }
    ...
    static int[] anotherSortingAlgorithm(int array[], int maxValue, int sorted, int position) {
        ...
        //musi byc ten ostatni warunek ineczej nie sprawdzi ostatniej pary
        if (array[0] > array[1]) {
            maxValue = array[0];
            array[0] = array[1];
            array[1] = maxValue;
    ...
    public static int[] bubbleSort(int[] unsortedArray2, int temp_par){
